...
PHASE_INSTRUCTIONS = {
    ...
    3: "物語の『結』です。結末に向かう決定的な心情や選択を描いてください。"
}

SERINENTIUS_RULE = (
    "【エンディング必須演出】\n"
    "- メロスはセリヌンティウスのもとへ向かい、辿り着く過程の状況または瞬間を描くこと\n"
    "- 必ず、メロスとセリヌンティウスの再会の成否は描写すること\n"
...
def choose():
    ...
    try:
        ...
        system_instruction = (
            "あなたは文学作品の語り手です。\n"
            "この物語は『走れメロス』を軸に、『こころ』『注文の多い料理店』『檸檬』の文学作品の世界が交錯するクロスワールドです。\n\n"
            
            "【重要な世界観ルール】\n"
            "- メロスが走る中で他の文学作品が介入し、メロスは他の文学作品の主人公のような働きかけを受けるが、最後には再び走ることを選択する存在である。\n"
            "- メロスは、結でセリヌンティウスと再会するまで立ち止まらない\n"
            "- 他の文学作品の人物・言葉・空間は、道中に『割り込む』『介入する』『語りかける』『影のように現れる』\n"
            "- メロスと他作品は、完全に理解し合わなくてよい。\n"
            "- 他の文学作品の人物・言葉・空間は、走り続けるメロスを『引き止める』『共に走る』\n\n"
            
            "【文章表現の制約】\n"
            "- 出力は地の文のみ（解説・説明・文字数表示は禁止）\n"
            "- 150字以内の一段落\n"
            "- 意味や印象の切れ目で改行を入れてよい\n"
        ...
        user_prompt = (
            ...
            f"その瞬間、彼の前に「{current_work}」の世界が滲み出す。\n"
            f"彼の感情は「{chosen_mood}」。\n"
