    ...
    library = [
        {
            ...
            先生と書くだけで本名は打ち明けない。これは世間を憚（はばか）る遠慮というよりも、その方が私にとって自然だからである。
            私はその人の記憶を呼び起こすごとに、すぐ「先生」といいたくなる。筆を執っても心持は同じ事である。
            よそよそしい頭文字（かしらもじ）などはとても使う気にならない。"""
            """「あなたは今、自由な、独立した、己れに充ちた現代の人間に生り切ろうとしている。しかしその反面には、
            孤独の寂しさを味わわなければならないのが、現代の人間が支払うべき報酬のようなものですよ。その代り自由な、
            独立した、己れに充ちた現代の人間は、愛に対して、またそれに応えるべきはずの犠牲を払わなければならなくなるのです」"""
        }
    ]
